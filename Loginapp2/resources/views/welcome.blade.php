...
<header class="flex items-center justify-between p-6">
    ...
    <div>
        ...
        @endguest
        @auth
            <a href="{{route('dashboard')}}" class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Dashboard</a>
        @endauth
    </div>
</header>
</body>
